...
INSERT INTO RequestCategories (requestSectionID, requestCategory) VALUES
	...
	(2, 'Операционные системы (Windows, Linux)'),
	(2, 'Офисные приложения (MS Office, LibreOffice)'),
	(2, 'Корпоративные системы (1С, CRM, ERP)'),
	(2, 'Антивирусное ПО и безопасность'),
	(2, 'Принтеры, МФУ, сканеры'),
	(2, 'Сетевое оборудование (роутеры, коммутаторы)'),
	(2, 'Проводная сеть (LAN, Ethernet)'),
	(2, 'Беспроводная сеть (Wi-Fi)'),
	(2, 'Серверное оборудование'),
	(2, 'Расходные материалы (картриджи, бумага)'),
